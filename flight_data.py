class FlightData:
    ...
    def find_cheapest_flight(self, flights_Data):
        ...
        if len(flights_Data['data']) == 0:
            ...
            first_flight = flights_Data['data'][0]
            lowest_price = float(first_flight["price"]["grandTotal"])
            self.stops = len(first_flight["itineraries"][0]["segments"]) - 1
            self.origin_airport = first_flight["itineraries"][0]["segments"][0]["departure"]["iataCode"]
            self.destination_airport = first_flight["itineraries"][0]["segments"][self.stops]["arrival"]["iataCode"]
            ...
            for each in flights_Data['data']:
                ...
                self.destination_airport = each["itineraries"][0]["segments"][self.stops-1]["arrival"]["iataCode"]
            ...
            return [lowest_price, self.origin_airport, self.destination_airport, self.out_date, self.return_date, self.stops]
